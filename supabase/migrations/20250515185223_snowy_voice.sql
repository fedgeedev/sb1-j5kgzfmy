/*
  # Add Therapist Likes Functions

  1. Functions
    - increment_therapist_likes: Increment likes count for a therapist
    - decrement_therapist_likes: Decrement likes count for a therapist
    - get_therapist_likes: Get current likes count for a therapist
    - update_therapist_likes_count: Trigger function to maintain likes count

  2. Triggers
    - update_therapist_likes_count_trigger: Automatically update likes count
*/
